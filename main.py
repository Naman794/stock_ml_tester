...
from analysis.ml_models import train_model_for_stock, predict_next_day

STOCKS = ["Infosys", "TCS", "HDFC Bank", "Reliance", "Bajaj Finance"]
...
def run_pipeline_for_stock(stock_name):
    ...
    train_model_for_stock(f"data/{filename}")
    predicted = predict_next_day(f"data/{filename}")
